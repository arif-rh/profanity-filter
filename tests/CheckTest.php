...
class CheckTest extends TestCase
{
	 ...
	 * @test
	 */
	public function itObfuscatesOnlyStringThatContainsAProfanity()
	{
		$this->assertEquals('what is ****? **** is nothing.', $this->checker->cleanWords("what is cunt? cunt is nothing."));
	}

	/**
	 * @test
	 */
	public function itObfuscatesOnlyStringThatContainsAProfanityWithCustomMask()
	{
		$this->assertEquals('what is ++++? ++++ is nothing.', $this->checker->cleanWords("what is cunt? cunt is nothing.", '+'));
	}
